...
public enum ErrorCode {
    ...
    // 추가/대체하면 되는 항목들만 발췌
    NOT_FOUND_REPLY_COMMENT("존재하지 않는 대댓글입니다.", HttpStatus.NOT_FOUND),
    INVALID_REPLY_COMMENT_OWNERSHIP("해당 회원이 작성한 대댓글이 아닙니다.", HttpStatus.FORBIDDEN),
    INVALID_REPLY_COMMENT_PARENT_RELATION("대댓글이 지정된 댓글에 속하지 않습니다.", HttpStatus.BAD_REQUEST),
